                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="email" name="email" value="{{old("email")}}" placeholder="Mail adresi giriniz">
                                    @error("email")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-check mt-3">
                                        <input class="form-check-input" type="checkbox" id="is_admin" value="1"
